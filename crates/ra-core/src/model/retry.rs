...
//!
//! R1-2b defines only the serializable configuration surface. R1-9 adds normalized provider
//! errors, advice, policies, and replay-safety decisions without changing these settings.
